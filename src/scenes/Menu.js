class Menu extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.audio('backgroundMusic', ['./assets/audio/An Infernal Dash.ogg', './assets/audio/An Infernal Dash.mp3']);
    }
    ...
    create() {       
        ...
        // Adjusting positions of buttons to prevent tangent line with platforms
